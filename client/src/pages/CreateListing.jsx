      ...
      <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-4">
        <div className="flex flex-col gap-4 flex-1">
          ...
          <div className="flex flex-wrap gap-6">
            <div className="flex items-center gap-2">
              <input
                className="p-3 border border-grey-slate-3 rounded-lg"
                type="number"
                id="bedrooms"
                min="1"
                max="10"
        ...
        <div className="flex flex-col flex-1 gap-4">
          <p className="font-semibold">
            Images:
            <span className="font-normal text-grey-slate-2">
          ...
          <div className="flex gap-4">
            <input
              ...
              accept="image/*"
              multiple
              className="p-3 border-grey-slate-2 rounded w-full"
            />
            <button
              type="button"
              disabled={uploading}
          ...
          <button disabled={loading || uploading} className="p-3 bg-grey-slate-3 text-white-1 rounded-lg uppercase hover:opacity-95 disabled:opacity-80">
